...
cd edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection
```
...
Using the `edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection/simulator/simulation_data/windturbine_data.csv` which is a normalized version of open source data wind turbine dataset (`edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection/training/T1.csv`) from <https://www.kaggle.com/datasets/berkerisen/wind-turbine-scada-dataset>.
...
at `edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection/time_series_analytics_microservice`. Directory details is as below:
...
#### **`models/`**:
   - The `windturbine_anomaly_detector.pkl` is a model built using the RandomForestRegressor Algo.
     More details on how it is built is accessible at `edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection/training/windturbine/README.md`
...
>    env variable in `.env` file at `edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection`)
