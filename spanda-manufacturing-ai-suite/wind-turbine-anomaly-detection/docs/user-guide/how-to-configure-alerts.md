...
By default, the following MQTT alerts is configured in `edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection/time_series_analytics_microservice/config.json` file.
...
already added. By default, the `edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection/time_series_analytics_microservice/tick_scripts/windturbine_anomaly_detector.tick` TICK Script has the following configuration done by default.
...
`edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection/time_series_analytics_microservice/tick_scripts/windturbine_anomaly_detector.tick`.
...
```sh
cd edge-ai-suites/spanda-manufacturing-ai-suite/wind-turbine-anomaly-detection # path relative to git clone folder
